...
public class ScriptOnImbalanced{
	...
	public static void main(String[] args) throws Exception{
	    ...
	    String path = "./FinalResult/KBS+24+plus"; 
		File root = new File("./arff-imbalance");
		...
		for(int f=0;f<files.length;f++){
		    ...
		    for(int p=0;p<extra_fold;p++){
		    	...
		    	for (int i=0;i<nr_fold;i++){
		    		...
		    		ArcGvUnsupervisedMarginVersion24 s = new ArcGvUnsupervisedMarginVersion24(classifier);
