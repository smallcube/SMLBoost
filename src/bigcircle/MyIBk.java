...
public class MyIBk extends Classifier implements OptionHandler, UpdateableClassifier, WeightedInstancesHandler,
  ...
  public Instances getNearestNeighbors(Instance instance) throws Exception {
	    if ((m_WindowSize > 0) && (m_Train.numInstances() > m_WindowSize)) {
	      m_kNNValid = false;
	      boolean deletedInstance=false;
	      while (m_Train.numInstances() > m_WindowSize) {
